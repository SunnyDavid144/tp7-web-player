  ...
  return (
    <div className={`tp7-wrapper ${motor.state.darkMode ? 'dark-mode' : ''}`}>
      <div className="tp7-device">
        ...
        <div className={`tp7-chassis ${isDragOver ? 'drag-over' : ''} ${motor.state.isRecording ? 'recording' : ''}`}
      ...
      <TrackList
        ...
        onSelectTrack={(i) => motor.selectTrack(i)}
        onRemoveTrack={(i) => motor.removeTrack(i)}
